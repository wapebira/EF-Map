...
// netlify/functions/get-share.js
var get_share_exports = {};
__export(get_share_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_share_exports);
...
async function handler(event) {
  try {
    ...
    if (!store)
      return { statusCode: 500, body: "Storage unavailable" };
    try {
...
//# sourceMappingURL=get-share.js.map
