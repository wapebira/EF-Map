...
const ECHO_POOL:string[] = [
  ...
  'MichaelSpaceJD: CEO in real life AND in-game. Someone stage an intervention.',
  'Reapers HR department (MichaelSpaceJD) still reviewing my “stop shooting newbies” memo.',
  'MichaelSpaceJD and Diddy McCoy: dynamic duo or hostage situation? Jury out.',
  ...
  'MichaelSpaceJD quarterly review: needs improvement in “letting rookies live 10 minutes”.',
