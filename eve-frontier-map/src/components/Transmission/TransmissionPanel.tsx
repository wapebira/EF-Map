...
const ECHO_POOL:string[] = [
  ...
  'Mission hub glitch #421: leaderboard counts the same pilot twice. 2FaceMonkey wrestling it—hes appreciated.',
  'Leaderboard says I ran -3 missions today. Time math experimental. 2FaceMonkey is on it and hes appreciated.',
  'Reward anomaly: completed mission, no payout, leaderboard shrug. 2FaceMonkey digging—hes appreciated.',
  'Patch note someday: “duplicate entries purged.” Until then: ghost pilots reign. 2FaceMonkey is working and appreciated.',
  'Mission marked half-complete, half-pending, fully confusing. 2FaceMonkey untangling it—hes appreciated.',
  'Leaderboard wobbling like a drunk freighter. Still, 2FaceMonkey keeps tightening bolts—hes appreciated.',
  'Raw used to anchor turret gardens outside stations. Now he showcases merch drops. Evolution or marketing pivot?',
  'Raw’s latest merch shot: nine logos, zero missions. Fashion killmail pending.',
  'Speculation: Raw replaced sentry guns with storefront mannequins. Safer margin, lower ammo burn.',
  'Audit: Raw’s merch pile > his recent combat log. Brand warfare meta confirmed.',
  'Barbatos requests “fair fight” with mirrored fits. Universe queues laughter politely.',
  'Barbatos refuses to undock larger hulls: “I only scale in purity, not tonnage.”',
  'Barbatos doctrine: perfection > escalation. Result: immaculate duels, zero logistics clutter.',
  'Optreal adding another tribe to his tour. Passport stamp space: critically low.',
  'Optreal claims he’s researching culture. Tribes claim he’s speedrunning rejection.',
  'Optreal transfer complete again. Gate toll collectors now wave him through by first name.',
  'Rumor: Optreal compiling a comparative thesis on welcome channel tone variance.',
  'GMGIGI response latency: near-instant. Tone: eerily templated. Might moonlight as a helpdesk AI.',
  'Pilots now prefix requests to GMGIGI with prompts. Efficiency reportedly increases.',
  'GMGemini macro detected: empathetic acknowledgment followed by structured bullet guidance.',
  'E. Varakova: “I won’t manage people.” Ten minutes later: channel taxonomy, icon set, SOP draft.',
  'Varakova reflex: sees empty chat → seeds it with a framework before finishing the disclaimer.',
  'E. Varakova oscillates between “hands-off” and “founding charter v3”. Productive contradiction.',
  'Habi multiboxes a small militia to blap a rookie shuttle. Strategic overcommitment or art form?',
  'Habi’s fleet roster: 20 clients, one target, zero chill.',
  'Telemetry: Habi alt tab rate surpasses average drone cycle frequency.',
  'Lopy mined enough to scaffold a mid-tier moon outpost, then asked if anyone needed more veld.',
  'Rumor: Lopy is three synchronized EXTI interns in a trench coat. Output levels suspicious.',
  'Reapers deploy Lopy like an industrial superweapon: wind-up, release, receive infrastructure.',
  ...
  // --- Added: CCP Jotun Tech Gremlin Humor ---
  'CCP Jotun stream checklist: mic? maybe. scene? shrug. vibes? intact.',
  'CCP Jotun located today\'s hidden setting: it was “Mute” again.',
  'Breaking: CCP Jotun defeats audio crackle by rebooting literally everything.',
  'CCP Jotun patch notes (unofficial): “Fixed nothing. Had fun. See you tomorrow.”',
  'If CCP Jotun\'s scene switch works first try, timeline instability suspected.',
  '“I\'m not a computer guy” — CCP Jotun, launching another complex broadcast anyway.',
  'Jotun hotfix: swapped USB port. Uptime record expected to shatter (by minutes).',
  'CCP Jotun overlay desynced from reality again. Feature, not bug.',
  'Chat latency test: CCP Jotun says “sound okay?”; chat replies “NO AUDIO.”',
  'Statistical anomaly: CCP Jotun started with correct mic AND feed. Investigation pending.',
  'CCP Jotun\'s GPU fans spin faster when Settings opens. Learned fear.',
  'Stream bingo: frozen cam, wrong scene, echo loop, shrug. Center square is “it works.”',
  // --- Added: New Player Encouragement ---
  'Rookie: feeling lost means you\'re exploring, not failing.',
  'First week tip: log every “Huh?” moment; later they become instincts.',
  'Everyone you respect wandered longer than they admit. Keep going.',
  'Quiet haul accomplished? That\'s proof you can carve calm from noise.',
  'Low ship count ≠ low progress. Knowledge compounds faster than hulls.',
  'Ask “obvious” questions early; silence trains worse habits.',
  'If you pause unsure: refuel, check cargo, review last jumps. Momentum returns.',
  'Scan discipline outgrows any module upgrade. Practice now.',
  'Map literacy is a force multiplier—you\'re building it reading this.',
  'Warp panic fades; situational awareness replaces it with reps.',
  'Rookie wins: cleaner fuel math, safer undocks, better intel notes.',
  'Don\'t rush a tribe; sample channel cadence first.',
  // --- Added: Referral / Onboarding (LUX economy) ---
  'Haven\'t used a referral yet? That\'s unclaimed LUX velocity—redeem one.',
  'Referral codes are catalysts, not chains. Apply it; keep roaming.',
  'Your hangar doesn\'t care whose referral you used. Your LUX ledger will.',
  'If a referral field blinks, it\'s free starter LUX waving.',
  'New account without referral: you left LUX behind. Turn back and pick it up.',
  // --- Added: Tribe / Community Join (generic, Wolf allowed) ---
  'Need social oxygen? Lurk multiple tribe chats before choosing.',
  'Not feeling the first tribe vibe? Iterate early; identity isn\'t locked.',
  'Joining any tribe isn\'t a collar—treat first pick as a trial.',
  'Solo is fine until you want comparative intel velocity. Community accelerates.',
  'Assess a tribe by how it answers rookie friction, not recruitment slogans.',
  'Notebook + shared intel feed (or its equivalent) = accelerated pattern recognition.',
  'If a tribe channel is only recruitment spam, keep auditioning.',
  'Healthy tribe sign: basic questions get patient answers.',
  'Switching tribes is refinement, not failure.',
  'Wolf welcomes curiosity; so do many others—sample before settling.',
  // --- Added: Subtle Map / Mechanics (no bookmarks; portable structures) ---
  'Before long roam: fuel check, probes, charges, portable structure kits.',
  'While planning, align or reposition—idling is lost safety time.',
  'Drop a portable structure safe mid-route; future pursuit evasion asset.',
  'Treat every flawless logistics cycle as baseline, not guarantee.',
  'Rename deployables meaningfully—“Cache-West” beats “Structure 4”.',
  // --- Added: Short Breathers / Ambient ---
  'You\'re earlier than the guides; exploit that asymmetry.',
  'Silence now is future contested lane space. Harvest it.',
  'Each clean extraction is dataset, not victory lap.',
  'Frontier confidence = calm checklists, not loud pings.',
  'Curiosity earns compound interest; impatience charges fees.',
  // --- Added: Meta / Self-Aware ---
  'If an echo repeats today, either quantum drift or my shuffle misbehaved.',
  'Channel recipe: guidance + mischief ÷ attention span constraints.',
  'Letting this run is low-key patience training.',
  'Glitch cadence doubles as anti-spam pacing—intentional.',
  'Reading this far indicates above-average attention endurance.',
  // --- Added: CCP Jotun Extended ---
  'CCP Jotun\'s rig blue-screened rendering a settings panel. Respect chaos.',
  'Jotun debug tactic: unplug, replug, narrate existential dread—effective.',
  'If CCP Jotun were a module: Adaptive Improvisation II (passive uptime aura).',
  'Priority inversion field detected: chat latency > video > audio sync.',
  'Place your bets: minutes until first scuffed transition?',
];
