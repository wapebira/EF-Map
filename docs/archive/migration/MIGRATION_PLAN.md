...
2025-09-11: Added local read-only indexer dashboard enhancements (file-based status/history ingestion, ETA calculation, throughput series, RPC auto-detect). No ingestion code touched; zero write operations; safe during catch-up.
